      ...
      <div className="max-w-4xl mx-auto px-8 sm:px-12 lg:px-16 relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Let the AI oracle assess your profile</h3>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Get a customized life or health premium proposal</h3>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Lock protection on-chain — instantly and securely</h3>
          </div>
        </div>
      </div>
    </section>
