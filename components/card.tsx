      ...
      <div className="relative w-full border-x border-zinc-400 dark:border-zinc-700">
        <div className="absolute z-0 grid h-full w-full items-center">
          <section className="absolute z-0 grid h-full w-full grid-cols-2 place-content-between">
            <div className="bg-primary my-4 size-1 -translate-x-[2.5px] rounded-full border border-8 border-gray-50 sm:my-6 md:my-8 dark:border-gray-950" />
            <div className="bg-primary my-4 size-1 translate-x-[2.5px] place-self-end rounded-full border border-8 border-gray-50 sm:my-6 md:my-8 dark:border-gray-950" />
            <div className="bg-primary my-4 size-1 -translate-x-[2.5px] rounded-full border border-8 border-gray-50 sm:my-6 md:my-8 dark:border-gray-950" />
            <div className="bg-primary my-4 size-1 translate-x-[2.5px] place-self-end rounded-full border border-8 border-gray-50 sm:my-6 md:my-8 dark:border-gray-950" />
          </section>
        </div>
